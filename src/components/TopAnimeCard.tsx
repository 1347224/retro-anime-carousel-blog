...
const TopAnimeCard = ({ rank, title, year, impact, legacy, imageUrl }: TopAnimeCardProps) => {
  ...
  return (
    <>
      ...
      >
        <div className="bg-gradient-to-b from-green-900/20 to-background rounded-lg overflow-hidden border-2 border-green-500/30 shadow-lg w-[250px] h-[300px] relative">
